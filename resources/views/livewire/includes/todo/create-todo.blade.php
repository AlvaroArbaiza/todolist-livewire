<div class="mb-5">
    ...
    {{-- card --}}
    <div class="card box-shadow-gray">
        ...
        <div class="card-body py-3 px-4">
            <form class="d-flex flex-row align-items-center">
                ...
                {{-- icon --}}
                <a 
                    data-mdb-toggle="tooltip" title="Set due date" class="me-3" id="icoDeadline"
                >

                    <svg 
                        id="icon" class="me-1 text-dark" xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-calendar-check" viewBox="0 0 16 16"
                    >
                ...
                {{-- Add button --}}
                <div>
                    <button wire:click.prevent="create" type="button" class="btn btn-purple px-4 box-shadow-gray">
                        Add                                    
                    </button>
                </div>
            </form>
