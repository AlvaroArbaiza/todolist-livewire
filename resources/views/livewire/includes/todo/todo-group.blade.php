...
>
    ...
    @if ($todo->deadline)
        ...
        <li class="list-group-item px-3 py-1 d-flex align-items-center border-0 bg-transparent">
            <div
                class="deadline-box py-2 px-3 me-2 border border-1 border-warning rounded-3 d-flex align-items-center bg-white box-shadow-yellow">
                <p class="small mb-0">
                    <a class="text-decoration-none" data-mdb-toggle="tooltip" title="Due on date">
    ...
    {{-- Options --}}
    <li class="options list-group-item ps-3 pe-0 py-1 rounded-0 border-0 bg-transparent">
        <div class="d-flex flex-row justify-content-end mb-2">

            {{-- Edit --}}
            <a 
                wire:click="edit({{ $todo->id }})" class="optionbutton text-primary text-decoration-none" data-mdb-toggle="tooltip" title="Edit todo"
            >
            ...
            {{-- Delete --}}
            <a 
                wire:click="delete({{ $todo->id }})" class="optionbutton text-danger text-decoration-none" data-mdb-toggle="tooltip" title="Delete todo"
            >
        ...
        {{-- Date --}}
        <div class="date text-end text-muted">
            <a class="text-muted text-decoration-none" data-mdb-toggle="tooltip" title="Created date">
